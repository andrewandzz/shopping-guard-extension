...
//     const result = data[key] as AnalysisResult;
...
//     if (!result.riskSignals || result.riskSignals.length === 0) {
...
// function setStaticPopupTexts(): void {
...
// function formatPageType(pageType: PageType) {
